...
UM_FUTURES_SYMBOLS_DIR = './Binance/config/binance/um.txt'
CM_FUTURES_SYMBOLS_DIR = './Binance/config/binance/cm.txt'
SPOTS_SYMBOLS_DIR = './Binance/config/binance/spot.txt'
